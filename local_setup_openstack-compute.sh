...
pkgos_inifile set /etc/nova/nova.conf cinder admin_username admin
pkgos_inifile set /etc/nova/nova.conf cinder admin_password "${admin_pass}"
...
pkgos_inifile set /etc/nova/nova.conf neutron ovs_bridge br-int
